...
QT_MOC_LITERAL(1, 6, 4), // "info"
QT_MOC_LITERAL(2, 11, 0), // ""
QT_MOC_LITERAL(3, 12, 9) // "APIFromUX"

    },
    "First\0info\0\0APIFromUX"
};
...
void First::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (First::*)(APIFromUX );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&First::info)) {
                *result = 0;
                return;
            }
        }
