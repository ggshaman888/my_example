...
QT_MOC_LITERAL(4, 23, 8) // "infoSlot"
    ...
    "Second\0info\0\0APIFromUX\0infoSlot"
};
...
void Second::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Second::*)(APIFromUX );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Second::info)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Second::info(APIFromUX _t1)
{
