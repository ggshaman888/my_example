...
int SetBaikal::prepareBuffer(const QByteArray& buf, const int& step_in)
{
    ...
    case 1: {
        int step_out = prepare->set_01_(buf);
...
void SetBaikal::setStep()
{
    ...
    step.s_13 = QString("\r");
    step.s_14 =
        QString("scp %1@%2:%3 ./\r").arg("user_ssh").arg("ip_server_ssh").arg("path_ssh");
    step.s_15 = QString("%1\r").arg("pass_ssh");
    step.e_15 = QString("/usr/bin/dbclient: Connection to %1@%2 exited: "
                        "Connect failed: No route to host")
                    .arg("user_ssh")
                    .arg("ip_server_ssh");
    step.s_16 =
        QString("scp %1@%2:%3 ./\r").arg("user_ssh").arg("ip_server_ssh").arg("path_ssh_fs");
    step.s_17 = QString("%1\r").arg("pass_ssh");
}
